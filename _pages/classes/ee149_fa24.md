...
2D Fourier Transform, Intro to Deconvolution</div>
                <div class="hw">HW 1 Released, Due 10/24</div>
            </div>
            </div>
        </div>
    </div>
    ...
    <div class="week-box">
        <div class="event">
            ...
            <div class="mid_section">
                <div class="event-title">Representing Local Correspondence I: Descriptors + Detectors</div>
                <!-- <div class="quiz">Quiz, Solutions</div> -->
            </div>
            <!-- <div class="level-1-links">
        ...
        <div class="event">
            <div class="top-level">
                ...
                <div class="mid_section">
                    ...
                    <div class="hw">HW 2 Releeased, Due 11/7, HW 1 Due</div>
                </div>
            </div>
        </div>
    </div>
...
Reconstruction in 3D Space (R3D): Camera Models</div>
    ...
    <div class="week-box">
        <div class="event">
            ...
            <div class="mid_section">
                <div class="event-title">Final Exam, 3-6AM, Location TBD</div>
