...
<header>
    ...
    <nav>
        <ul>
            ...
            <li><i class="fa-duotone fa-bars fa-sm fa-fw"></i>&nbsp;Platforms: BruinLearn, Piazza (Coming Soon)</li>
        </ul>
    </nav>
</header>
...
<section id="evaluation">
    <h2>Evaluation</h2>
    <p style="color: red">This section is under construction. Expect changes</p>
    <p>Your final grade will be made up of: <strong>TBD</strong></p>
    <!-- <ul>
...
<section id="contact">
    ...
    <ul>
        <li><strong>TBD</strong>, Prof. Kadambi.</li>
...
<section id="syllabus">
    <h2>Schedule</h2>
    <p><p style="color: red">This section is still under construction. Expect changes</p> Dates and topics are likely to change during the semester. Blank slides are subject to updates, so download the latest version at the start of lecture. We will try, but it is not gaurenteed that there will be a lecture recording for all lectures.</p>    
    <h4>Week 1</h4>
    <div class="week-box">
        <div class="event">
            <div class="top-level">
