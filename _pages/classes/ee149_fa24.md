...
<header>
    ...
    <nav>
        <ul>
            ...
            <li><i class="fa-duotone fa-location-dot fa-sm fa-fw"></i>&nbsp;Location: Rolfe Hall Room 3116</li>
...
<section id="evaluation">
    <h2>Evaluation</h2>
    <p style="color: red">This section may change slightly over the first few days of the quarter.</p>
...
Reconstruction in 3D Space</div>
    ...
    <div class="week-box">
        ...
        <div class="event">
            ...
            <div class="mid_section">
                <div class="event-title">Deep Learning III: Mask RCNNs</div>
                <!-- <div class="quiz">Quiz, Solutions</div> -->
                <!-- <div class="hw">HW 4 Due</div> -->
            </div>
            </div>
