...
<section id="syllabus">
    ...
    <div class="week-box">
        ...
        <div class="event">
            ...
            <div class="second_section">
                <div class="level-1-links">
                    <div class="p_cen qui">Quiz, Solutions</div>
...
2D Fourier Transform, Intro to Deconvolution</div>
                <!-- <div class="quiz">Quiz, Solutions</div> -->
                <div class="hw">HW 1 released, Due 2/1.</div>
                <div class="hw">HW 1 Solutions: PDF</div>
            </div>
            <div class="second_section">
                <div class="level-1-links">
                    <div class="p_cen">Quiz, Solutions</div>
    ...
    <div class="week-box">
        ...
        <div class="event">
            ...
            <div class="mid_section">
                ...
                <!-- <div class="quiz">Quiz, Solutions</div> -->
                <div class="hw">HW 2 released, Due 2/20. HW 1 Due</div>
                <div class="hw">HW 2 Solutions: PDF, Code</div>
            </div>
            <div class="second_section">
                <div class="level-1-links">
                    <div class="p_cen">Quiz, Solutions</div>
    ...
    <div class="week-box">
        ...
        <div class="event">
            <div class="top-level">
                ...
                <div class="second_section">
                    <div class="level-1-links">
                        <div class="p_cen">Quiz, Solutions</a></div>
    ...
    <div class="week-box">
        ...
        <div class="event">
            ...
            <div class="mid_section">
                ...
                <!-- <div class="quiz">Quiz, Solutions</div> -->
                <div class="hw">HW 3 released, Due 2/29.</div>
                <div class="hw">HW 3 Solutions: PDF Code</div>
            </div>
            <div class="second_section">
                <div class="level-1-links">
                    <div class="p_cen">Quiz, Solutions</div>
    ...
    <div class="week-box">
        ...
        <div class="event">
            ...
            <div class="mid_section">
                ...
                <!-- <div class="quiz">Quiz, Solutions</div> -->
                <div class="hw">HW 4 released, Due 3/14. </div>
                <div class="hw">HW 4 Solutions: PDF, Code</div>
